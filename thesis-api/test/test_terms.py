...
def test_get_random__existing_terms__returns_one():
    with contextmanager(get_test_db)() as db:
        ...
        db.add(TermModel(name='t1', initial_difficulty=0.5, difficulty=0.5, category_id=5))
        db.add(TermModel(name='t2', initial_difficulty=0.5, difficulty=0.5, category_id=5))
        db.flush()
